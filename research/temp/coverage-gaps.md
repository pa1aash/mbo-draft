...
**No `uncovered` (0-source) atomic items.** Thinnest = N3 and N7 (both Adequate); W1/W3 completion
summaries + the step-8 corpus critic will top these up. One candidate gap flagged for step 8:
**Dao et al., "Boosting offline optimizers with surrogate sensitivity" (ICML 2024)** — surfaced in
Tan's bibliography, directly on the N7 smoothness/sensitivity axis, not yet fetched.
