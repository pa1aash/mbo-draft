...
| 5 | T1 | `docs/DECISION_QUEUE.md` | 145 | 7,829 | |
| 6 | T2 | `code/mbo.py` | 710 | 34,856 | |
...
| 14 | T2 | `code/stats.py` | 164 | 8,124 | |
| 15 | T2 | `code/run05.py` | 234 | 13,115 | |
| 16 | T2 | `code/db_tasks.py` | 109 | 5,620 | |
| 17 | T2 | `code/figures.py` | 417 | 18,819 | |
| 18 | T2 | `code/tables.py` | 74 | 3,766 | |
| 19 | T2 | `code/run_gpcov.py` | 68 | 3,393 | |
| 20 | T2 | `code/run_beta0.py` | 84 | 3,776 | |
| 21 | T2 | `code/run_subsample.py` | 63 | 2,961 | |
| 22 | T2 | `code/quicklook.py` | 85 | 4,687 | |
| 23 | T2 | `requirements.txt` | 11 | 282 | |
| 24 | T2 | `cloud/setup.sh` | 83 | 5,194 | |
| 25 | T2 | `cloud/fix_designbench.sh` | 61 | 3,870 | |
| 26 | T2 | `cloud/local_queue.sh` | 31 | 2,130 | |
| 27 | T2 | `cloud/Dockerfile` | 14 | 657 | |
| 28 | T2 | `cloud/queue/run_queue.sh` | 25 | 1,170 | |
| 29 | T2 | `cloud/queue/run_after_01.sh` | 29 | 1,643 | |
| 30 | T2 | `cloud/queue/00_smoke.sh` | 13 | 764 | |
| 31 | T2 | `cloud/queue/01_synth_factorial.sh` | 19 | 1,003 | |
| 32 | T2 | `cloud/queue/02_db_factorial.sh` | 26 | 1,410 | |
| 33 | T2 | `cloud/queue/03_official_baselines.sh` | 41 | 2,239 | |
| 34 | T2 | `cloud/queue/04_calibration.sh` | 14 | 749 | |
...
| 42 | T3 | `docs/PREREGISTRATION.md` | DOES NOT EXIST | 0 | |
| 43 | T3 | `PREREGISTRATION.md` | 66 | 3,612 | |
| 44 | T3 | `docs/PREREGISTRATION_V2.md` | 32 | 3,724 | |
| 45 | T3 | `docs/NOVELTY.md` | DOES NOT EXIST | 0 | |
| 46 | T3 | `docs/NOVELTY_CHECK.md` | 331 | 36,371 | |
| 47 | T3 | `docs/SCOPE_EXPANSION.md` | DOES NOT EXIST | 0 | |
| 48 | T3 | `docs/FLAW_LEDGER.md` | 423 | 28,093 | |
| 49 | T3 | `docs/FREE_WINS.md` | DOES NOT EXIST | 0 | |
| 50 | T3 | `docs/FREE_WIN_5_1_offline_selection.md` | 422 | 27,314 | |
| 51 | T3 | `docs/FREE_WIN_5_3_eta_robustness_raw.txt` | 165 | 10,405 | |
| 52 | T3 | `docs/MECHANISM_EXPERIMENTS.md` | 217 | 12,124 | |
| 53 | T3 | `docs/CHAT_DIGEST.md` | 106 | 7,845 | |
| 54 | T3 | `docs/VENUE_NORMS.md` | 427 | 29,277 | |
| 55 | T3 | `docs/ARTIFACT_INVENTORY.md` | 447 | 30,913 | |
| 56 | T3 | `docs/scripts_offline_selection.py` | 503 | 27,543 | |
| 57 | T3 | `docs/scripts_eta_robustness.py` | 506 | 23,916 | |
| 58 | T4 | `docs/hyperresearch/01_decompose_coverage-matrix.md` | 44 | 4,577 | |
| 59 | T4 | `docs/hyperresearch/01_decompose_prompt-decomposition.json` | 70 | 6,010 | |
| 60 | T4 | `docs/hyperresearch/02_<step>.md` | DOES NOT EXIST | 0 | |
| 61 | T4 | `docs/hyperresearch/03_<step>.md` | DOES NOT EXIST | 0 | |
| 62 | T4 | `docs/hyperresearch/04_<step>.md` | DOES NOT EXIST | 0 | |
| 63 | T4 | `docs/hyperresearch/05_<step>.md` | DOES NOT EXIST | 0 | |
| 64 | T4 | `docs/hyperresearch/06_<step>.md` | DOES NOT EXIST | 0 | |
| 65 | T4 | `docs/hyperresearch/07_<step>.md` | DOES NOT EXIST | 0 | |
| 66 | T4 | `docs/hyperresearch/08_<step>.md` | DOES NOT EXIST | 0 | |
| 67 | T4 | `docs/hyperresearch/09_<step>.md` | DOES NOT EXIST | 0 | |
| 68 | T4 | `docs/hyperresearch/10_<step>.md` | DOES NOT EXIST | 0 | |
| 69 | T4 | `docs/hyperresearch/11_<step>.md` | DOES NOT EXIST | 0 | |
| 70 | T4 | `docs/hyperresearch/12_<step>.md` | DOES NOT EXIST | 0 | |
| 71 | T4 | `docs/hyperresearch/13_<step>.md` | DOES NOT EXIST | 0 | |
| 72 | T4 | `docs/hyperresearch/14_<step>.md` | DOES NOT EXIST | 0 | |
| 73 | T4 | `docs/hyperresearch/15_<step>.md` | DOES NOT EXIST | 0 | |
| 74 | T4 | `docs/hyperresearch/16_<step>.md` | DOES NOT EXIST | 0 | |

**Files/blocks in manifest: 74** (of which DOES NOT EXIST: 22)
...
|---|---|
| `docs/FINAL_REPORT.md` | never created this session; the final report was delivered in chat, not written to disk |
| `docs/GRADTUNE_RESULT.md` | never created; the gradtune result lives verbatim in FLAW_LEDGER.md P0-0 |
| `docs/UNSUPPORTED_CLAIMS.md` | never created; unsupported/untraceable claims live in PROVENANCE.md and FLAW_LEDGER.md P0-4 |
| `docs/PREREGISTRATION.md` | no file at this path. The ORIGINAL pre-registration is at repo root PREREGISTRATION.md; the revision pre-registration is docs/PREREGISTRATION_V2.md. Both included below under their real paths. |
| `docs/NOVELTY.md` | no file at this path; the novelty check is docs/NOVELTY_CHECK.md, included below |
| `docs/SCOPE_EXPANSION.md` | never created. Phase 7 scope-expansion decisions were folded into the "Rejected, with reasons" section of docs/EXTENSION_LEDGER.md rather than given their own file. |
| `docs/FREE_WINS.md` | no file at this path. Only 5.1 completed and it is docs/FREE_WIN_5_1_offline_selection.md, included below. 5.3 produced raw output only (agent died before writing its summary); 5.2/5.4 never ran. |
| `docs/hyperresearch/02_<step>.md` | hyperresearch step 2 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/03_<step>.md` | hyperresearch step 3 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/04_<step>.md` | hyperresearch step 4 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/05_<step>.md` | hyperresearch step 5 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/06_<step>.md` | hyperresearch step 6 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/07_<step>.md` | hyperresearch step 7 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/08_<step>.md` | hyperresearch step 8 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/09_<step>.md` | hyperresearch step 9 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/10_<step>.md` | hyperresearch step 10 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/11_<step>.md` | hyperresearch step 11 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/12_<step>.md` | hyperresearch step 12 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/13_<step>.md` | hyperresearch step 13 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/14_<step>.md` | hyperresearch step 14 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/15_<step>.md` | hyperresearch step 15 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |
| `docs/hyperresearch/16_<step>.md` | hyperresearch step 16 never ran. Only steps 1-2 of the 16-step pipeline were executed; the literature work was delegated to focused agents instead (see chat log / NOVELTY_CHECK.md, VENUE_NORMS.md). |

---

## FILE: __X1X3_STATUS__
<!-- live status; generated at bundle time -->

### Live status

**There was no pre-existing X1 run.** No shell was running when this task began: `ps` showed no grid process, `logs/` did not exist, and no `x1x3*` file existed anywhere. X1 had never been launched.

**Why it could not have been running:** there is no PyTorch on this machine. `venv/` is a *Windows-layout* venv (`Include/ Lib/ Scripts/`) and has no macOS interpreter; the miniforge python has numpy 2.4.4 but no torch, botorch, gpytorch, or cma. The published results were produced on a RunPod cloud pod via `cloud/setup.sh`, not locally.

**What I did:** implemented X1 and X3 in `code/mbo.py` as reversible switches (`X1_STANDARDIZE_Y`, `X3_MATCHED_PROTOCOL`), then launched a background driver that builds an isolated venv (NOT the user's miniforge base, which other projects pin to numpy 2.4.4), smoke-tests the switches, and runs the full synthetic grid at 30 seeds.
...
```
=== [Fri Jul 17 16:28:24 IST 2026] STEP 1: build isolated env ===
--- installing pinned requirements (this is the long pole) ---
--- verify ---
torch 2.11.0 | numpy 2.4.4 | sklearn 1.8.0
botorch 0.18.1 | gpytorch 1.15.2
cma 4.4.4

=== [Fri Jul 17 16:30:52 IST 2026] STEP 2: smoke (X1/X3 switches + one cell per optimizer) ===
X1_STANDARDIZE_Y = True | X3_MATCHED_PROTOCOL = True
Branin-2D: raw y [-293.85,-0.37] | ens_scale ym=-55.576 ys=52.867 (y.std=52.867)
  init rows=256
  ens x grad     -> {'p100': -10.960893630981445, 'p50': -10.960893630981445}
  ens x perturb  -> {'p100': -1.6296310424804688, 'p50': -10.960893630981445}
  ens x cma      -> {'p100': -10.96080207824707, 'p50': -10.960887908935547}
Griewank-30D: raw y [-1560.07,-351.25] | ens_scale ym=-902.931 ys=145.408 (y.std=145.408)
  init rows=256
  ens x grad     -> {'p100': -1879.544799816637, 'p50': -1960.9006348183739}
  ens x perturb  -> {'p100': -327.00805665747015, 'p50': -522.0608216734112}
  ens x cma      -> {'p100': -1641.7094697234327, 'p50': -1659.2998046894586}
SMOKE OK

=== [Fri Jul 17 16:31:07 IST 2026] STEP 3: full synthetic grid, X1+X3, 30 seeds ===
0 cells, 7 workers
...
---
## FILE: docs/FINAL_REPORT.md — DOES NOT EXIST
<!-- never created this session; the final report was delivered in chat, not written to disk -->

---
## FILE: docs/GRADTUNE_RESULT.md — DOES NOT EXIST
<!-- never created; the gradtune result lives verbatim in FLAW_LEDGER.md P0-0 -->

---
## FILE: docs/UNSUPPORTED_CLAIMS.md — DOES NOT EXIST
<!-- never created; unsupported/untraceable claims live in PROVENANCE.md and FLAW_LEDGER.md P0-4 -->

---
## FILE: docs/DECISION_QUEUE.md
<!-- lines: 145 | bytes: 7829 | last commit: 9cacc8b 2026-07-17 -->
```markdown
# Decision queue
...
---
## FILE: code/gradtune.py
<!-- lines: 71 | bytes: 3647 | last commit: cdd5ad8 2026-07-12 -->
```python
...
---
## FILE: code/run_all.py
<!-- lines: 189 | bytes: 9837 | last commit: bb50904 2026-07-17 -->
```python
...
---
## FILE: __GIT_CDD5AD8__
<!-- git show cdd5ad8 --stat --format=full -->

```
commit cdd5ad8643921bb389581b5849b14a5754a72a0f
Author: juunnq <arjunveluri.work@gmail.com>
Commit: juunnq <arjunveluri.work@gmail.com>

    Robustness: gradient trust-region/normalization knobs + gradtune.py sweep (rebut 'under-tuned optimizer' objection). Smoke: trust region closes the ensemble gradient collapse
...
1e29586 Harden the fabrication caution: four caught, not one
19e88c6 X4: pre-empt the tinyBenchmarks inverse-framing trap
70c7664 AAAI has published this genre four times; and a caught fabrication
a7aa2a0 Upgrade X4: a power analysis over TASK COUNT fills a named 20-year gap
e3aeeed Design-Bench scoop check: not scooped, but the task set is entangled with P0-5
4e05863 Correct P2-8 (my error: Li/Rudner/Wilson is ICLR 2024) and add citation traps
a67e9a7 Correct the venue read: AAAI has published this genre in its main track
dd5d7cb Venue norms: NeurIPS 2026 adds a Negative Results category; AAAI has none
8074264 Extension ledger, three paper identities, and revision pre-registration
9cacc8b Phase 5 reanalysis: offline selection FAILS; eta-squared reproduces exactly
6818888 P0-0: the repo's own gradient-tuning sweep refutes the paper's mechanism
e02059c Repo map: structure, per-file purpose, and orphan analysis
ee4e03f Mechanism experiments: M0-M6 with pre-registered predictions and kill criteria
bd5960c Flaw ledger: 7 P0, 8 P1, 8 P2, 3 P3 findings with T1-T12 verdicts
f90f975 Recon: implementation audit, claim provenance, artifact inventory
7559bc5 hyperresearch step 1: prompt decomposition, coverage matrix, run scaffold
bb50904 Import current draft, code, and experiment artifacts
8ebab0b Add surrogate x optimizer attribution infra: matched-tuning GATE-1 knob, SEI/OEI analysis, TOST + Nemenyi CD stats, numbered dependency-ordered run queue
cdd5ad8 Robustness: gradient trust-region/normalization knobs + gradtune.py sweep (rebut 'under-tuned optimizer' objection). Smoke: trust region closes the ensemble gradient collapse
ff25b6a Revert scipy pin (conflicts with deepchem); sparse_gp fails-and-skips on DB via runner robustness
70d4868 Robustness: per-cell exception handling (one bad cell no longer kills the run); scipy<1.9 for sklearn 1.0.2 Ridge
a64f9ab DB full grid: --db-subsample cap (TFBind10=4M rows) + botorch/gpytorch/cma in db env so no cells skip on real tasks
367aa92 Design-Bench works: fix_designbench.sh (8 fixes — HF-mirror data, numpy/sklearn pins, source patches) wired into setup.sh
7a77eeb setup.sh db: pin numpy<2 (design-bench np.NINF) + seed SMILES vocab so import doesn't crash on ChEMBL
40050db setup.sh: idempotent conda detection (reuse existing miniconda on rerun)
a241dae setup.sh: accept conda channel ToS + modern mujoco pkg names (fresh-pod blockers)
3145230 gitattributes: force LF on shell scripts (CRLF broke setup.sh on Linux pod)
5f685c7 Plan alignment: ScaledAckley ladder family (d ladder + density knob), pre-registration contract, ladder usage doc
667a7b9 setup.sh: bootstrap miniconda + mujoco system deps for bare RunPod containers
e07ddd4 Analysis layer complete: LaTeX table generator (tables.py) + CD diagram (Demsar); R2 baseline strategy folded into skeleton
5f61765 Paper planning: section skeleton (contributions, narrative, related-work map) + Prop 1/2 formal spine for the mechanism section
06f4274 Analysis: figures.py (Okabe-Ito colorblind-safe grid+coverage figures); Windows multiprocessing guard + single-writer note in runner
a66d73a Fix SVGP gradient cell: predict in train mode to avoid eval-cache freed-graph crash on repeated backward
f3dbd6b Cloud infra: Design-Bench adapter (db_tasks.py), --db runner path, setup.sh (3 envs), Dockerfile
71299d8 Engine: compositional surrogate x optimizer grid + CMA-ES + SVGP + conformal calibration arm; parallel --jobs runner
598b8b2 Baseline: consolidated pipeline (mbo.py/run_all.py/stats.py), legacy quarantined, packaging files
```

---
## FILE: docs/IMPLEMENTATION_AUDIT.md
<!-- lines: 1224 | bytes: 67550 | last commit: f90f975 2026-07-17 -->
````markdown
...
<!-- lines: 827 | bytes: 72163 | last commit: f90f975 2026-07-17 -->
```markdown
...
<!-- lines: 142 | bytes: 7676 | last commit: 8ebab0b 2026-07-13 -->
```python
...
---
## FILE: code/stats.py
<!-- lines: 164 | bytes: 8124 | last commit: 8ebab0b 2026-07-13 -->
```python
...
---
## FILE: code/run05.py
<!-- lines: 234 | bytes: 13115 | last commit: bb50904 2026-07-17 -->
```python
...
---
## FILE: code/db_tasks.py
<!-- lines: 109 | bytes: 5620 | last commit: bb50904 2026-07-17 -->
```python
...
---
## FILE: code/figures.py
<!-- lines: 417 | bytes: 18819 | last commit: bb50904 2026-07-17 -->
```python
...
---
## FILE: code/tables.py
<!-- lines: 74 | bytes: 3766 | last commit: e07ddd4 2026-07-11 -->
```python
...
---
## FILE: code/run_gpcov.py
<!-- lines: 68 | bytes: 3393 | last commit: bb50904 2026-07-17 -->
```python
...
---
## FILE: code/run_beta0.py
<!-- lines: 84 | bytes: 3776 | last commit: bb50904 2026-07-17 -->
```python
...
---
## FILE: code/run_subsample.py
<!-- lines: 63 | bytes: 2961 | last commit: bb50904 2026-07-17 -->
```python
...
---
## FILE: code/quicklook.py
<!-- lines: 85 | bytes: 4687 | last commit: bb50904 2026-07-17 -->
```python
...
<!-- lines: 11 | bytes: 282 | last commit: 71299d8 2026-07-11 -->
```text
# Versions pinned from the environment the existing results were produced with.
torch==2.11.0
numpy==2.4.4
scipy==1.17.1
scikit-learn==1.8.0
matplotlib==3.10.8
# Needed only for the GP-gradient and SVGP grid cells:
botorch
gpytorch
# Needed only for the CMA-ES optimizer cells:
cma
```

---
## FILE: cloud/setup.sh
<!-- lines: 83 | bytes: 5194 | last commit: 367aa92 2026-07-12 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/fix_designbench.sh
<!-- lines: 61 | bytes: 3870 | last commit: ff25b6a 2026-07-12 -->
```bash
#!/usr/bin/env bash
...
# NOTE: sklearn 1.0.2's Ridge (used only by the sparse_gp baseline) calls a scipy API
# removed in >=1.9, but deepchem needs scipy>=1.10 — irreconcilable. Exact GP + the
# Superconductor oracle work fine with sklearn 1.0.2 + modern scipy; sparse_gp just
# fails-and-skips per-cell on DB (runner tolerates it). So we do NOT pin scipy here.
...
---
## FILE: cloud/local_queue.sh
<!-- lines: 31 | bytes: 2130 | last commit: bb50904 2026-07-17 -->
```bash
#!/usr/bin/env bash
...
<!-- lines: 14 | bytes: 657 | last commit: f3dbd6b 2026-07-11 -->
```dockerfile
# Reproducible `main` env (synthetic grid + calibration arm). Ships in the supplement.
# Design-Bench (db) and design-baselines (baselines) are NOT in here — their legacy
# deps don't containerize cleanly; cloud/setup.sh provisions them as conda envs.
#   docker build -f cloud/Dockerfile -t offline-mbo .
#   docker run --rm offline-mbo python code/mbo.py
...
CMD ["python", "code/mbo.py"]
```

---
## FILE: cloud/queue/run_queue.sh
<!-- lines: 25 | bytes: 1170 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/run_after_01.sh
<!-- lines: 29 | bytes: 1643 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/00_smoke.sh
<!-- lines: 13 | bytes: 764 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/01_synth_factorial.sh
<!-- lines: 19 | bytes: 1003 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/02_db_factorial.sh
<!-- lines: 26 | bytes: 1410 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/03_official_baselines.sh
<!-- lines: 41 | bytes: 2239 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/04_calibration.sh
<!-- lines: 14 | bytes: 749 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/05_analyze.sh
<!-- lines: 32 | bytes: 1662 | last commit: 8ebab0b 2026-07-13 -->
```bash
#!/usr/bin/env bash
...
---
## FILE: cloud/queue/README.md
<!-- lines: 56 | bytes: 3357 | last commit: 8ebab0b 2026-07-13 -->
````markdown
...
---
## FILE: .gitattributes
<!-- lines: 1 | bytes: 17 | last commit: 3145230 2026-07-12 -->
```text
*.sh text eol=lf
```
...
# --- model checkpoints / large binaries (regenerable) ---
*.pt
*.ckpt
*.npz
wandb/
...
paper/latex_source/*.aux
paper/latex_source/*.log
paper/latex_source/*.out
paper/latex_source/*.bbl
paper/latex_source/*.blg
paper/latex_source/*.synctex.gz
paper/aaai27/kit.zip

# --- run scratch ---
# NOTE: results/results_camera.json and results/results_db.json were previously
# ignored here as "preview/scratch". They are the primary artifacts backing the
# manuscript's headline numbers and are now tracked.
results/*.log
results/*.tmp

# hyperresearch vault internals (audit trail lives in docs/)
.hyperresearch/
research/notes/
research/raw/
